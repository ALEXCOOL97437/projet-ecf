...
if (isset($_POST['envoi'])) {
    ...
    if (!empty($_POST['pseudo']) && !empty($_POST['mdp'])) {
        ...
        $inserMembre = $bdd->prepare('INSERT INTO producteurs(pseudo, mdp) VALUES (?, ?)');
...
<header>
    ...
    <div class="input-action">
        <button type="submit" id="buttonInscription" name="envoi">Inscrire nouveau producteur</button>
    </div>
    </form>
